...
folder are mapped to the application's root namespace, 'ExtJs6_web'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExtJs6_web"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtJs6_web' in the same way
as `"ExtJs6_web/sass/src"`.
